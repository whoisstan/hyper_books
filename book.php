...
<head><title>Hyper Books</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black" /><meta name="viewport" content="initial-scale=1.0;maximum-scale=1.0;user-scalable=no;width=device-width">
<link rel="apple-touch-icon-precomposed" href="images/icon.png"><link rel="apple-touch-icon" href="images/icon.png"><link rel="apple-touch-startup-image" href="images/startup.png"><link rel="stylesheet" href="style/book.build.css" type="text/css" charset="utf-8"><script>if (window.applicationCache.status==window.applicationCache.UPDATEREADY){window.applicationCache.update();window.applicationCache.swapCache();}
if(window.location.href.indexOf('debug')>-1)
{alert('sreen-width/height='+window.innerWidth+"/"+window.innerHeight);	alert('sreen-width/height='+screen.width+"/"+screen.height);	alert('client-width/height='+document.documentElement.clientWidth+"/"+document.documentElement.clientHeight);}</script>
<script src="js/jquery.js" type="text/javascript" charset="utf-8"></script><script src="js/all.build.js" type="text/javascript" charset="utf-8"></script></head><body class="width"><div id='bar' class="width">
<div class='top'><div id='home' class='button'>Library</div><div id='hide_bar' class='button'>Back</div>		
<div style='clear:both'></div><div  class='title'>Book Title</div><div  class='authors'>Book Title</div>				</div>		
...
<div class="menu_panels width"><ul  id='available_for_download_en' class='menu_panel width' ></ul><ul  id='available_for_download_de' class='menu_panel width' ></ul>	</ul></div></div></div><script>setTimeout(function(){window.scroll(0,1)},10);</script></body></html>